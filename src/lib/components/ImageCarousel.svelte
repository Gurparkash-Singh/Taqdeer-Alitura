...
<div id="image-carousel">
	<button aria-label="previous image" onclick={prevImage} class:oneImage={data.images.length <= 1}>
	...
	{#each data.images as image}
		<div class="carousel-holder" class:showImage={image.image_id == showImage}>
			<picture>
