	...
	<a href="/shop" aria-label="shop">
		<svg width="20" height="22" viewBox="0 0 40 44" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
				...
				stroke={current == "shop" ? "#900B09" : "#1E1E1E"}
				stroke-width="4"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
	...
	<a href="/profile" aria-label="profile">
		<svg width="16" height="16" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
                ...
                fill={current == "profile" ? "#900B09" : "#1E1E1E"}
			/>
		</svg>
	</a>
</div>
	...
	<a href="/" aria-label="home page">
		<svg width="20" height="22" viewBox="0 0 40 44" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
				...
				stroke={current == "home" ? "#900B09" : "#1E1E1E"}
				stroke-width="4"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
...
<div id="cart">
	<a href="/cart" id="cart" aria-label="cart">
		<svg width="26" height="24" viewBox="0 0 48 46" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
				...
				stroke={current == "cart" ? "#900B09" : "#1E1E1E"}
				stroke-width="4"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
