...
<section id="menu">
	...
	{/if}
	<a href="/profile/orders" class:order_span>
			...
			<dd>
				{#if data.user.email}
					...
					{#if !data.user.verified_email}
						<a href="/verify?email=true" data-sveltekit-preload-data="off"> verify </a>
					{/if}
				{/if}
			</dd>
			<dt>Name</dt>
			...
			<dd>
				{#if data.user.phone}
					...
					{#if !data.user.verified_phone}
						<a href="/verify?phone=true" data-sveltekit-preload-data="off"> verify </a>
					{/if}
				{:else}
