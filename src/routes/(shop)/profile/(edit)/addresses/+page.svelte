...
<section>
	<AddressBookMap {setValue} />
	<form action="?/create" method="POST">
		<input type="hidden" name="formatted-address" bind:value={formattedAddress} />
		...
		<fieldset id="button-holder">
			...
			<button
				type="submit"
				formaction="?/delete"
				class:disable-submit={selected_address == 'add'}
				disabled={selected_address == 'add'}
			>
				Delete
				<svg
					width="10"
