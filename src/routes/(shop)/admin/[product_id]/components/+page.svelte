...
<section>
	<form action="?/submit" method="POST">
		<p>
			...
			<select name="currentComponent" id="currentComponent" bind:value={selectedComponent}>
		...
		<p>
			...
			<input type="text" name="component_name" id="component_name" bind:value={newName} />
		</p>
		<p>
			<label for="desc">component description (optional):</label>
			<input type="text" name="desc" id="desc" bind:value={description} />
		</p>
		<div>
