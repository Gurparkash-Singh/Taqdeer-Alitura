...
<section>
	<form action="?/submit" method="POST">
		...
		<p>
			...
			<input type="text" name="alt_desc" id="alt_desc" bind:value={alt_desc} />
		</p>
		<p>
			<label for="category_id">category:</label>
			<select name="category_id" id="category_id" bind:value={category}>
		...
		<p>
			...
			<select name="collection_id" id="collection_id" bind:value={collection}>
