<script>
	...
	let enableSubmit = $derived.by(() => {
		if (selectedCollection == 'Add' && newName) {
			return true;
		}
...
<section>
	<form action="?/submit" method="POST">
		<p>
			<label for="currentCollection">collection:</label>
			<select name="currentCollection" id="currentCollection" bind:value={selectedCollection}>
				{#each data.collections as collection}
					<option value={collection.collection_id}>
						{collection.collection_name}
					</option>
				{/each}
				<option value="Add">Add New Collection</option>
			</select>
		</p>
		<p>
			<label for="collection_name">collection name:</label>
			<input type="text" name="collection_name" id="collection_name" bind:value={newName} />
		</p>
		<p>
			<label for="live">live:</label>
			<input type="checkbox" name="live" id="live" bind:checked={live} />
		</p>
		<div>
