...
<Map {setValue} {manualEntry} />

<section>
	<form action="?/create" method="POST">
		<input type="hidden" name="formatted-address" bind:value={formalAddress} />
		<input type="hidden" name="manual-entry" bind:value={manual} />
		<input
			type="hidden"
			name="address-id"
		...
		{/if}
		<fieldset class:delivery-visible={showMessage} class:delivery-invisible={!showMessage}>
			...
			<p>
				...
				<input type="text" name="address1" id="address1" required bind:value={address1} />
			</p>
			<p>
				<label for="address2">address line 2 (optional):</label>
				<input type="text" name="address2" id="address2" bind:value={address2} />
			</p>
			<p>
				<label for="city">city:</label>
				<input type="text" name="city" id="city" required bind:value={city} />
			</p>
			<p>
				<label for="province">state/province:</label>
				<input type="text" name="province" id="province" required bind:value={province} />
			</p>
			<p>
				<label for="postal">postal code:</label>
				<input type="text" name="postal" id="postal" required bind:value={postal_code} />
			</p>
			<p>
				<label for="delivery_country">country code:</label>
				<select name="delivery_country" id="delivery_country" required bind:value={country}>
		...
		<fieldset>
			...
			<p>
				...
				<select name="country" id="country" required bind:value={countryCode}>
					{#each getCountries() as country}
						{#if country != 'IL'}
							<option value={country}>
			...
			<p>
				...
				<input type="tel" name="phone" id="phone" required bind:value={phoneNumber} />
			</p>
		</fieldset>
