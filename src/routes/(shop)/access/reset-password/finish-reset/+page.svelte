<script>
	...
	let enableSubmit = $derived.by(() => {
		let filledFields = password && confirmPassword;

		return filledFields && passwordValid && confirmPassword == password;
	});
...
<section>
	<form action="?/submit" method="POST">
		...
		<div id="message" class:showMessage>
			...
			<p class:invalid={!hasUpperLetter} class:valid={hasUpperLetter}>uppercase letter</p>

			<p class:invalid={!hasLowerLetter} class:valid={hasLowerLetter}>lowercase letter</p>
			<p class:invalid={!hasNumber} class:valid={hasNumber}>number</p>
			<p class:invalid={!has8} class:valid={has8}>eight characters</p>
		</div>
		<p>
